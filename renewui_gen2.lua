...
local tag
local info = {}
local PresetColor = Color3.fromRGB(0, 128, 255) or _G.UI_Color
local logo = 8497547113

if game:GetService("CoreGui"):FindFirstChild("Nova") then
	game:GetService("CoreGui"):FindFirstChild("Nova"):Destroy()
end

if game:GetService("CoreGui"):FindFirstChild("StrikeCourseUI") then
	game:GetService("CoreGui"):FindFirstChild("StrikeCourseUI"):Destroy()
end

profile = info["profile"] or "https://www.roblox.com/headshot-thumbnail/image?userId=".. game.Players.LocalPlayer.UserId .."&width=420&height=420&format=png"
username =  info["username"] or game.Players.LocalPlayer.Name
tag = info["tag"] or tostring(math.random(1,10))

local STRIKECourseUI = Instance.new("ScreenGui")
STRIKECourseUI.Parent = game:GetService("CoreGui")
STRIKECourseUI.Name = "StrikeCourseUI"
STRIKECourseUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
STRIKECourseUI.Enabled = false

local UiToggle = Instance.new("Frame")

UiToggle.Name = "UI_TOGGLE"
UiToggle.Parent = STRIKECourseUI
...
UiToggle.BorderColor3 = Color3.fromRGB(0,128,255)
...
UiToggleminiFrame.BackgroundColor3 = Color3.fromRGB(0, 128, 255)
UiToggleminiFrame.BackgroundTransparency = 0
UiToggleminiFrame.BorderColor3 = Color3.fromRGB(0,128,255)
...
TitleUiToggle.TextColor3 = Color3.fromRGB(0, 128, 255)
...
UiToggleImage.Image = "https://www.roblox.com/asset-thumbnail/image?assetId="..logo.."&width=0&height=0&format=png"
...
function StrikeCourse:Window(text,maincolor)
   ...
   MainFrame.Size = UDim2.new(0, 615, 0, 399)

   local uitoggled2 = false
   game:GetService("UserInputService").InputBegan:connect(function(inputObject, gameProcessedEvent)
      pcall(function()
         if inputObject.KeyCode == Enum.KeyCode.RightControl then
            if uitoggled2 == false then
               MainFrame:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
               wait(0.2)
               RadientPaidSC.Enabled = false
               uitoggled2 = true
            else
               RadientPaidSC.Enabled = true
               MainFrame:TweenSize(UDim2.new(0, 615, 0, 399), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.3, true)
               uitoggled2 = false
            end
         end
      end)
   ...
   MainFrameTitle.BorderSizePixel = 1
   ...
   MainFrameTitle.ClipsDescendants = true
   MainFrameTitle.Text = GameName
   ...
   MainFrameTitle.Position = UDim2.new(0.50, 0, 0.03, 0)
   MainFrameTitle.Size = UDim2.new(0, 615, 0, 30)
   MainFrameTitle.TextXAlignment = Enum.TextXAlignment.Center
   ...
   CloseBtn.BackgroundColor3 = Color3.fromRGB(255,255,255) -- 15, 15, 15
   CloseBtn.BackgroundTransparency = 1
   CloseBtn.Position = UDim2.new(0.95, 0, 0.001, 0)
   ...
   MinimizeBtn.BackgroundColor3 = Color3.fromRGB(255,255,255) -- 15, 15, 15
   MinimizeBtn.BackgroundTransparency = 1
   MinimizeBtn.Position = UDim2.new(0.9, 0, 0.001, 0)
...
--[[   Userpad.Name = "Userpad"
   ...
   UserImage.Image = "http://www.roblox.com/asset/?id=8188583286"
   ...
   UserCircleImage.Image = "rbxassetid://8189369516"
   ...
   UserName.Text = "Nova Hub"
   UserTag.Text = "#" .. " Nova Hub"]]
   ...
   CloseBtn.MouseButton1Click:Connect(
      function()
         ...
         UiToggle:TweenSize(UDim2.new(0, 200, 0, 70), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.8, true)
         wait(0.2)
         NovaA.Enabled = true
         uitoggled1 = true
      end
   ...
   UserSettingsPadUser.Font = Enum.Font.GothamBold
   ...
   UserSettingsPadUser.Text = username
   ...
   UserSettingsPadTag.Font = Enum.Font.GothamBold
   ...
   UserPanelUserImage.Image = profile
   ...
   UserPanelUserIcon.MouseButton1Click:Connect(function()
      ...
      AvatarTextbox.Font = Enum.Font.GothamBold
      AvatarTextbox.Text = ""
      ...
      ChangeBtn.MouseButton1Click:Connect(function()
         profile = tostring(AvatarTextbox.Text)
      ...
      ResetBtn.MouseButton1Click:Connect(function()
         profile = "https://www.roblox.com/headshot-thumbnail/image?userId=".. game.Players.LocalPlayer.UserId .."&width=420&height=420&format=png"
         UserImage.Image = profile
         UserPanelUserImage.Image = profile
         SaveInfo()
   ...
   UserPanelTag.Font = Enum.Font.GothamBold
   ...
   EditBtn.MouseButton1Click:Connect(function()
      ...
      HashtagLabel.Font = Enum.Font.GothamBold
      HashtagLabel.Text = "#"
      ...
      TagTextbox.Font = Enum.Font.GothamBold
   ...
   function StrikeCourse:Notification(titletext, desctext, btntext)
      ...
      AlrightBtn.Font = Enum.Font.GothamBold
   ...
   function ServerHold:Server(text)
      ...
      local imageServerFrame = Instance.new("ImageLabel")
      ...
      ServerTitle.Position = UDim2.new(0.25, 0, 0, 0)
      ...
      imageServerFrame.Parent = ServerTitleFrame
      imageServerFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
      imageServerFrame.BackgroundTransparency = 1.000
      imageServerFrame.AnchorPoint = Vector2.new(0.5, 0.5)
      imageServerFrame.Position = UDim2.new(0.12, 0, 0.54, 0)
      imageServerFrame.Size = UDim2.new(0, 25, 0, 22)
      imageServerFrame.Image = "https://www.roblox.com/asset-thumbnail/image?assetId="..logo.."&width=0&height=0&format=png"
      ...
      Hashtag.Font = Enum.Font.GothamBold
      Hashtag.Text = "#"
      ...
      ChannelTitle.Position = UDim2.new(0.0462470865, 0, 0, 0)
      ...
      TimeGlobal.Name = "TimeGlobal"
		...
		TimeGlobal.Position = UDim2.new(0.8062470865, 0, 0, 0) -- 0.7062470865, 0, 0, 0
      ...
      function ChannelHold:Channel(text)
         ...
         ChannelBtn.AutoButtonColor = true
         ...
         ChannelBtnHashtag.Font = Enum.Font.GothamBold
         ...
         ChannelBtnTitle.Font = Enum.Font.GothamBold
         ...
         function ChannelContent:Toggle(text,default,callback)
            ...
            --[[ToggleText.Position = UDim2.new(0, 174, 0, 20)
            ToggleText.Size = UDim2.new(0, 350, 0, 20)]]

            ToggleText.Name = "ToggleText"
            ToggleText.Parent = Toggle
            ToggleText.AnchorPoint = Vector2.new(0.5, 0.5)
            ToggleText.BackgroundColor3 = Color3.fromRGB(255, 0, 255)
            ToggleText.BackgroundTransparency = 1
            ToggleText.BorderSizePixel = 0
            ToggleText.Position = UDim2.new(0, 178, 0, 20)
            ToggleText.Size = UDim2.new(0, 350, 0, 20)
            ...
            ToggleFrameIn.BackgroundColor3 = PresetColor
            ToggleFrameIn.Position = UDim2.new(0, 367, 0, 7)
            ToggleFrameIn.Size = UDim2.new(0, 25, 0, 25)
            ...
            ToggleTap.BackgroundTransparency = 1
            ToggleTap.Size = UDim2.new(0, 400, 0, 42)
         ...
         function ChannelContent:Slider(text, min, max, start, callback)
            ...
            SliderTitle.BackgroundColor3 = PresetColor
         ...
         function ChannelContent:Dropdown(text,text2,callback,list)
            local DropFunc = {}
            local itemcount = 0
            local framesize = 0
            local DropTog = false
            ...
            CurrentSelectedText.Font = Enum.Font.GothamBold
            CurrentSelectedText.Text = text2
            ...
            DropItemHolderLabel.Font = Enum.Font.GothamBold
         ...
         function ChannelContent:Colorpicker(text, preset, callback)
            ...
            HueGradient.Color = ColorSequence.new {
               ...
               ColorSequenceKeypoint.new(0.60, PresetColor),
